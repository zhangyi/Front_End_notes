...
<xsl:if test="system-property('xsl:vendor')='Transformiix'">p
<script type="text/javascript" src="js/decoding.js"></script>
</xsl:if>
...
<li class="vlog even">
	...
	<div name="decodeable"><xsl:value-of select="content:encoded" disable-output-escaping="yes" /></div>
</li>
</xsl:template>
